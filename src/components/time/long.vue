<template>
  <div
    ...
    <div class="md:ml-5 flex-grow text-sm md:text-base mb-2 md:mb-0 w-full md:w-auto">{{ title }}</div>
    <div class="flex flex-wrap gap-1 md:gap-2 w-full md:min-w-[150px] md:justify-end">
